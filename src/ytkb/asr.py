...
from ytkb.config import AsrConfig, ProxyConfig, YtDlpConfig
from ytkb.youtube import TranscriptFetchResult, download_audio_for_asr
...
def transcribe_with_faster_whisper(
    *,
    ...
    temp_dir = Path(tempfile.mkdtemp(prefix="ytkb-asr-"))
    try:

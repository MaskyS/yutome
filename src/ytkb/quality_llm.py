...
from ytkb.config import GeminiConfig
from ytkb.hashing import sha256_text
from ytkb.quality import derived_transcript
from ytkb.transcripts import NormalizedTranscript, TranscriptSegment, clean_text
    ...
    try:
        cache = await client.aio.caches.create(
            ...
            config=types.CreateCachedContentConfig(
                display_name=f"ytkb-cleanup:{video_id}",

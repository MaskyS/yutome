...
DEFAULT_CONFIG_FILENAME = "ytkb.toml"

DEFAULT_CONFIG_TOML = """# ytkb project configuration
...
# Generic proxy URLs can also come from YTKB_PROXY_URLS / YTKB_HTTP_PROXY / YTKB_HTTPS_PROXY.
# urls = ["http://user:pass@host1:port", "socks5://user:pass@host2:port"]
# http = "http://user:pass@host:port"
# https = "http://user:pass@host:port"
# Webshare credentials can also come from YTKB_WEBSHARE_USERNAME / YTKB_WEBSHARE_PASSWORD.

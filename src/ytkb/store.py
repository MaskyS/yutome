...
from ytkb.chunking import CHUNKER_VERSION, Chunk
from ytkb.db import connect_catalog
from ytkb.hashing import sha256_json
from ytkb.youtube import DiscoveredVideo
...
def list_catalog_videos(connection: sqlite3.Connection) -> list[DiscoveredVideo]:
